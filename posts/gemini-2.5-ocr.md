...
I've had a little tool on my site for visualising bounding boxes for a while [here](https://michael.mcand.ru/tools/bbox.html).
I used this here to visualise the results.
...
I *think* example (2) in particular does have better results, but it's still far from
